...
public class ContaLaboratorio {
    /**
     * Nome do Laboratório da UFCG
     * Padrão: LCCX sendo x podendo ser 1, 2 ou 3
     */
    private String nomeLaboratorio;

    /**
     * Cota da conta do Laboratório (em MB)
     * cota >= 0
     * cota padrão: 2000
     */
    ...
    /**
     * Armazena quanto da cota o usuário consumiu
     * consumo >= 0
    ...
    /**
     * Constroi uma Conta do laboratório a partir de seu nome
     * Sera contruido com a cota padrão de 2000mb
     *
     ...
     *
     * @return true se consumo for maior ou igual a cota, false se consumo for menor que a cota
     */
     ...
     * Padrão: Nome do Laborotario   Espaço Consumido/Cota
     *
